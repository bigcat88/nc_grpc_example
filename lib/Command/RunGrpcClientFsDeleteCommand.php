...
class RunGrpcClientFsDeleteCommand extends Command {
	...
	protected function configure(): void {
		$this->setName("nc_grpc_example:grpc:client:fs:delete");
		$this->setDescription("Run GRPC client FsDelete request");
		...
		$this->addArgument(self::ARGUMENT_FILEID, InputArgument::REQUIRED);
	}

	protected function execute(InputInterface $input, OutputInterface $output): int {
		$this->serverService->testFsDeleteFile($input, $output);
		return 0;
	}
}
